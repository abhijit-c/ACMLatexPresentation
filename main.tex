...
Documentclass is a special command, that basically defines the entire format.
It takes the formatting you define and derives the typographic form of the pdf
to reflect the choices you made.
...
What exactly is this \mintinline{latex}{\begin{document} \end{document}}? An
enviornment:

\begin{enumerate}
\item<1-> Performs an action on a block of text.
\item<2-> You can make your own!
\end{enumerate}
